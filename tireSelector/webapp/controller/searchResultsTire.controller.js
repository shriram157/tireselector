...
sap.ui.define([
	...
	return BaseController.extend("tireSelector.controller.searchResultsTire", {
		onInit: function () {
			...
			sap.ui.core.UIComponent.getRouterFor(_that).attachRoutePatternMatched(_that._oSelectTireRoute, _that);
		...
		_oSelectTireRoute: function (oEvent) {
			...
			_that.AddressID = _that.userDetails.DealerData.AddressID;
			...
			// 	_that.oTireFitmentJSONModel.setData(true);
							...
							if (oData.results.length > 0) {
								...
								if (_that.tempModel.getData().results.length <= 0) {
									...
									function getDealerNet(oMaterial) {
										...
										_that.promise1 = new Promise(function (resolve, reject) {
									...
									_that.promise1.then(function (value) {
										console.log("fina tempmodel data", value);
										if (_that.tempModel.getData().results.length > 0) {
											_that.promise2 = new Promise(function (resolve1, reject1) {
										...
										setTimeout(function() {
									_that.promise2.then(function (value) {
										console.log("fina tempmodel data", value);
										...
										_that.Filters[0] = removeDuplicates(_that.Filters[0]);
										_that.Filters[1] = removeDuplicates(_that.Filters[1]);
										_that.Filters[2] = removeDuplicates(_that.Filters[2]);
										_that.Filters[3] = removeDuplicates(_that.Filters[3]);
										_that.Filters[4] = removeDuplicates(_that.Filters[4]);
										...
										_that.oTireFitmentJSONModel.getData().Filters.push(_that.Filters[1]);
										_that.oTireFitmentJSONModel.getData().Filters.push(_that.Filters[2]);
										_that.oTireFitmentJSONModel.getData().Filters.push(_that.Filters[3]);
										_that.oTireFitmentJSONModel.getData().Filters.push(_that.Filters[4]);
										_that.oTireFitmentJSONModel.updateBindings(true);
		...
		onRowPress: function (oRowEvt) {
			...
			sap.ui.core.UIComponent.getRouterFor(_that).navTo("tireQuotation", {
