	...
	return BaseController.extend("tireSelector.controller.tireQuotation", {
		...
		generatePDF: function (oEvent) {
			...
			var headers = {
				...
				"x-odata-custom-oth_item_1": this.getView().byId("valItem1").getValue(),
				"x-odata-custom-oth_item_1_pr": ModelData2.otherItemPrice1,
				"x-odata-custom-oth_item_2": this.getView().byId("valItem2").getValue(),
				"x-odata-custom-oth_item_2_pr": ModelData2.otherItemPrice2,
				"x-odata-custom-oth_item_3": this.getView().byId("valItem3").getValue(),
				"x-odata-custom-oth_item_3_pr": ModelData2.otherItemPrice3,
				"x-odata-custom-oth_item_4": this.getView().byId("valItem4").getValue(),
				"x-odata-custom-oth_item_4_pr": ModelData2.otherItemPrice4,
